...
import aspectRatioCalculator from '@/content/tools/math/aspect-ratio-calculator/meta';
...
import unitPriceCalculator from '@/content/tools/lifestyle/unit-price-calculator/meta';
